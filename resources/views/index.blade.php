    ...
    <div class="container">
        <div class="row">
            <div class="categories__slider owl-carousel">
                ...
                <div class="col-lg-3">
                    <div class="categories__item product__discount__item__pic set-bg" data-setbg="{{URL::asset($img)}}">
                        <?php if ($row->sales > 0) :?>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix type-<?php echo $value['id'] ?>">
                <div class="featured__item">
                    ...
                    <div class="product__discount__item__text">
                        <h5><a
                                href="{{URL($id)}}"><?php if(strlen($value->product_name) > 30) { echo substr($value->product_name, 0, 30) . "..."; } else { echo $value->product_name; } ?></a>
                        </h5>
